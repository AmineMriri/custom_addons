...
class HMSPortal(CustomerPortal):
    ...
    @http.route(['/my/appointments/<int:appointment_id>'], type='http', auth="user", website=True, sitemap=False)
    ...
    @http.route(['/my/prescriptions/<int:prescription_id>'], type='http', auth="user", website=True, sitemap=False)
    ...
    @http.route(['/acs/cancel/<int:appointment_id>/appointment'], type='http', auth="user", website=True, sitemap=False)
    ...
    @http.route(['/my/evaluations/<int:evaluation_id>'], type='http', auth="user", website=True, sitemap=False)
